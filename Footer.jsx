  ...
  <div className="container px-4 mx-auto">
    <div className="pt-24 pb-11 mx-auto max-w-4xl">
        <a className="block md:mx-auto mb-5 max-w-max" href="#">
         <Image src="/asset/logo1.jpg" alt="mainlogo/logo" width={200} height={80} />
      ...
      <div className="flex flex-wrap justify-center -mx-3 lg:-mx-6">
        ...
        <div className="w-full md:w-auto p-3 md:px-6"><a href=""
            className="inline-block text-lg text-gray-500 hover:text-gray-600 font-medium">Contact Us</a>
        </div>
